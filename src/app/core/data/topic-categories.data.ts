        ...
        items: [
            {
                ...
                route: 'angular-cli',
                overview: 'Angular CLI helps create, build, test, and maintain Angular apps using standard commands.',
                keyPoints: [
                    'ng new creates a new Angular application',
                    'ng serve runs the dev server locally',
                    'ng generate creates components, services, pipes, and more',
                ],
                interviewTips: [
                    'Explain why Angular CLI improves consistency and productivity',
                    'Mention common commands like ng new, ng serve, ng build, ng generate',
                ],
            },
            {
                ...
                overview: 'Angular is a modern TypeScript-based framework, while AngularJS is the older JavaScript-based framework.',
                keyPoints: [
                    'Angular uses components; AngularJS used controllers and scopes',
                    'Angular supports TypeScript and modern tooling',
                    'Angular has better performance and maintainability',
                ],
                interviewTips: [
                    'Focus on architecture differences',
                    'Mention performance, tooling, and long-term support',
                ],
            },
            {
        ...
        items: [
            {
                ...
                overview: 'Signals provide a simple reactive state model in Angular for reading and updating values.',
                keyPoints: [
                ...
                interviewTips: [
                    'Explain how signals differ from Observables at a high level',
                    'Mention simple local state management use cases',
                ],
            },
            {
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                description: 'ryanair-cheap-flights',
